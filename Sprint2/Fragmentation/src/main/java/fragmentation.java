...
public class fragmentation {
    ...
    public static void main(String[] args) {
        ...
        String urlInstance1 = "jdbc:mysql://instance1_ip:instance1_port/instance1_database";

        String urlInstance2 = "jdbc:mysql://instance2_ip:instance2_port/instance2_database";
